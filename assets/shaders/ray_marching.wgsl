...
fn get_slope(current_pos: vec2<f32>) -> vec2<f32> {
    var displacement = textureSample(slope_texture, textureSampler, current_pos / tile_1, 0).xy;
    displacement += textureSample(slope_texture, textureSampler, current_pos / tile_2, 1).xy;
    displacement += textureSample(slope_texture, textureSampler, current_pos / tile_3, 2).xy;
    return displacement;
}
